...
public class ConfigUtility 
{
    ...
    public Properties loadProperties() throws IOException 
    {
        ...
        defaultProps.setProperty("mail.smtp.host", "smtp.office365.com");
        defaultProps.setProperty("mail.smtp.port", "587");
        defaultProps.setProperty("mail.user", "studentlife@unc.edu");
        defaultProps.setProperty("mail.password", "Areno9!1111111111");
